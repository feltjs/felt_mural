...
export const package_json = {
	...
	modules: {
		'./item.js': {
			path: 'item.ts',
			declarations: [
				{name: 'SvgItem', kind: 'TypeAliasDeclaration'},
				{name: 'ItemId', kind: 'TypeAliasDeclaration'},
				{name: 'SvgBaseItem', kind: 'InterfaceDeclaration'},
				{name: 'SvgPolylineItem', kind: 'InterfaceDeclaration'},
				{name: 'SvgCircleItem', kind: 'InterfaceDeclaration'},
				{name: 'parseItemPointsData', kind: 'VariableDeclaration'},
				{name: 'toPointsData', kind: 'VariableDeclaration'},
				...
				{name: 'createPolyline', kind: 'VariableDeclaration'},
				{name: 'createCircle', kind: 'VariableDeclaration'},
				{name: 'parsers', kind: 'VariableDeclaration'},
				{name: 'updateItemData', kind: 'VariableDeclaration'},
				{name: 'MuralAction', kind: 'TypeAliasDeclaration'},
				{name: 'MuralBaseAction', kind: 'InterfaceDeclaration'},
				{name: 'AddItem', kind: 'InterfaceDeclaration'},
				{name: 'UpdateItem', kind: 'InterfaceDeclaration'},
				{name: 'RemoveItem', kind: 'InterfaceDeclaration'},
				{name: 'RemoveAllItems', kind: 'InterfaceDeclaration'},
				{name: 'UpdateItemData', kind: 'TypeAliasDeclaration'},
			],
		},
		'./Mural.svelte': {path: 'Mural.svelte', declarations: []},
		'./MuralItem.svelte': {path: 'MuralItem.svelte', declarations: []},
		'./MuralItemList.svelte': {path: 'MuralItemList.svelte', declarations: []},
		'./MuralItemListItem.svelte': {path: 'MuralItemListItem.svelte', declarations: []},
